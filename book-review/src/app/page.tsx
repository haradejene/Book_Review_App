    ...
    <div className="bg-gray-900 min-h-screen text-white">
      ...
      <main className="p-6">
        <section className="flex flex-row">
          ...
          <section>
            <div
              className={`m-6 ${irishgroverFont.className} pt-[149px] pl-[34px] w-[670px] h-[116px]`}
            >
              <h1 className="text-5xl text-white font-light">
                Your Library of Opinions—<br />
            ...
            <div className="pl-[40px]">
              <button
                className={`m-6 ${irishgroverFont.className} w-[309px] h-[66px] bg-white/10 text-white rounded-lg flex items-center justify-center text-lg`}
              >
                Discover Books
              </button>
            </div>
